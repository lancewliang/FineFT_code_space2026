...
| 2 | TradingDay | 结算日 |
| 3 | UpdateTime | 交易时间 |
| 4 | InstrumentID | 组合合约 id。SP-跨期套利，SPC-跨品种套利。 |
| 5 | LastPrice | 最新价，始终是空，没有值。 |
| 6 | LastTradeVolume | 最新成交量，预留字段，始终是 0。 |
| 7 | LowPrice | 最低价，始终是空，没有值。 |
| 8 | HighPrice | 最高价，始终是空，没有值。 |
| 9 | LifeLowPrice | 历史最低价，始终是空，没有值。 |
| 10 | LifeHighPrice | 历史最高价，始终是空，没有值。 |
| 11 | UpperLimitPrice | 涨停价，第一个合约涨停板价 - 第二个合约跌停板价。 |
| 12 | LowerLimitPrice | 跌停价，第一个合约跌停板价 - 第二个合约涨停板价。 |
| 13 | BidPrice1 | 申买价一 |
| 14 | BidVolume1 | 申买量一 |
| 15 | BidPrice2 | 申买价二 |
| 16 | BidVolume2 | 申买量二 |
...
| 3 | UpdateTime | 交易时间 |
| 4 | InstrumentID | 合约代码 |
| 5 | BidPrice | 买最优价格，基本定单中的买方向的最优价格。 |
| 6 | BidOrderV1 | 委托量一，最优价上，按时间排序的前 10 笔委托。 |
| 7 | BidOrderV2 | 委托量二 |
| 8 | BidOrderV3 | 委托量三 |
| 9 | BidOrderV4 | 委托量四 |
| 10 | BidOrderV5 | 委托量五 |
...
| 14 | BidOrderV9 | 委托量九 |
| 15 | BidOrderV10 | 委托量十 |
| 16 | AskPrice | 卖最优价格，基本定单中的卖方向的最优价格。 |
| 17 | AskOrderV1 | 委托量一，最优价上，按时间排序的前 10 笔委托。 |
| 18 | AskOrderV2 | 委托量二 |
| 19 | AskOrderV3 | 委托量三 |
| 20 | AskOrderV4 | 委托量四 |
| 21 | AskOrderV5 | 委托量五 |
