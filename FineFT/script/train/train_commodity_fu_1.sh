...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-1min_multi}

mkdir -p "log/fu/low_level/train/1min/${EXPERIMENT_NAME}"
...
python -u FineFT/RL/DiHFT/low_level/weight_advantage_pretrain.py \
    ...
    --initial_wallet_balance 25000 --batch_size 8192 --update_times=40 \
