...
mkdir -p "log_futures/fu/low_level/train/1min/${EXPERIMENT_NAME}"
...
python -u FineFT/RL/DiHFT/low_level/weight_advantage_pretrain.py \
    ...
    --initial_wallet_balance 10000 --batch_size 4096 --update_times=30 \
    ...
    >"log_futures/fu/low_level/train/1min/${EXPERIMENT_NAME}/advantage-1min.log"
