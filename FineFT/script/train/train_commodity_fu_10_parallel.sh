...
numactl --cpunodebind=0 --preferred=0 python -u FineFT/RL/DiHFT/low_level/parallel_weight_advantage_pretrain.py \
    ...
    --initial_wallet_balance 6000 --batch_size 102400 --update_times=300 \
    ...
    --pretrain_epoch 5 --curriculum_block_epochs 5 --num_epoch 40 --lr_init 0.0005 --ada_init 96.0 --epsilon_min 0.05 \
