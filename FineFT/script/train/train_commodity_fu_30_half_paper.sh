...
python -u FineFT/RL/DiHFT/low_level/weight_advantage_pretrain_paper.py \
    ...
    --position_choices 5 --transcation_cost 0.0006 --n_step 12 --gamma 0.9999 \
    ...
    >"log/fu/low_level/train/30min/${EXPERIMENT_NAME}/advantage-paper-formula3-30min.log"
