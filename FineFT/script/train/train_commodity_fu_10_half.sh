...
mkdir -p "log_futures/fu/low_level/train/10min/${EXPERIMENT_NAME}"
...
python -u FineFT/RL/DiHFT/low_level/weight_advantage_pretrain.py \
    ...
    --initial_wallet_balance 12000 --batch_size 2048 --update_times=30 \
    --max_holding_number 2 --short_estimated_rate 0 --long_estimated_rate 0 \
    --position_choices 5 --transcation_cost 0.0003 --n_step 12 --gamma 0.99 \
    ...
    >"log_futures/fu/low_level/train/10min/${EXPERIMENT_NAME}/advantage-10min_multi.log"
