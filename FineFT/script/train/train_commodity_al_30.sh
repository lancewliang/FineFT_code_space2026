...
mkdir -p "log_futures/al/low_level/train/30min/${EXPERIMENT_NAME}"
...
python -u FineFT/RL/DiHFT/low_level/weight_advantage_pretrain.py \
    ...
    --initial_wallet_balance 100000 --batch_size 512 --update_times=30 \
    ...
    --pretrain_epoch 30 --lr_init 0.001 --epsilon_min 0.05 \
    --ada_min 1.0 --ada_step 2000000 \
    >"log_futures/al/low_level/train/30min/${EXPERIMENT_NAME}/advantage-30min.log"
