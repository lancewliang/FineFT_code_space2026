...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-5min_parallel2}
...
python -u FineFT/RL/DiHFT/low_level/parallel_weight_advantage_pretrain.py \
    ...
    --initial_wallet_balance 6000 --batch_size 102400 --update_times=4000 \
    ...
    --order_book_depth 5 --early_stop 2  --N 13 --buffer_size 4000000 \
    --pretrain_epoch 10 --num_epoch 10 --decay_epochs 7 --lr_init 0.0005 --ada_init 256.0 --epsilon_min 0.05 \
