...
def initiate_base_env(
    ...
    bid_prices_names = [
        "bid{}_price".format(i) for i in range(1, order_book_depth + 1)
    ]
    ask_prices_names = [
        "ask{}_price".format(i) for i in range(1, order_book_depth + 1)
    ]
    bid_sizes_names = [
        "bid{}_size".format(i) for i in range(1, order_book_depth + 1)
    ]
    ask_sizes_names = [
        "ask{}_size".format(i) for i in range(1, order_book_depth + 1)
    ]
