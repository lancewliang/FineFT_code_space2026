...
parser.add_argument(
    "--result_path",
    type=str,
    default="result/DiHFT/ablation/FineFT_wo_pretrain",
...
class Weighted_Contexts_DQN:
    def __init__(self, args):
        ...
        self.model_path = os.path.join(
            args.result_path, args.dataset_name, "FineFT_wo_pretrains"
        )
    ...
    def train(self):
        ...
        for sample in range(self.num_sample):
            ...
            for index in range(self.N):
                ...
                print("diverse train with using context index policy {}".format(index))
                while True:
