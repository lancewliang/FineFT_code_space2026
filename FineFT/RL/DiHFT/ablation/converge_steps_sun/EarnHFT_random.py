...
#! change the result into random sample version
import sys
...
parser.add_argument(
    "--result_path",
    type=str,
    default="result/DiHFT/ablation/EarnHFT_Random",
...
class DQN(object):
    ...
    def train(self):
        ...
        for sample in range(self.num_sample):
            df_index = np.random.choice(range(df_number))
