...
class weighted_trader:
    def __init__(self, args):
        ...
        self.model_path = os.path.join(
            args.result_path, args.dataset_name, "weights_advantage"
        )
    ...
    def act_test(self, state, info):
        ...
        action_value_chosen_index=action_value_chosen_index_mean-0.0001*action_value_chosen_index_std
    ...
    def test(self):
        ...
        np.save(
            os.path.join(self.epoch_path, "average_analysis_result.npy"), overall_result
        )
