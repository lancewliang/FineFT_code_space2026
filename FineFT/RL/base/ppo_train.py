...
import torch
import numpy as np
from model.low_level import *
import argparse
from tqdm import tqdm
import random
from RL.base.util.replay_buffer_PPO import ReplayBuffer
...
class PPO(object):
    ...
    def update(self, replay_buffer: ReplayBuffer):
        print("updating")
        (s, t, p_a, a_a, a, a_logprob, r, s_, t_, p_a_, dw, done) = (
        ...
        with torch.no_grad():  # adv and v_target have no gradient
            vs = self.critic(s, t, p_a)
            vs_ = self.critic(s_, t_, p_a_)
        ...
        for _ in range(self.K_epochs):
            ...
            for index in BatchSampler(
                ...
                dist_now = Categorical(
                    logits=self.actor(s[index], t[index], p_a[index], a_a[index])
                )
                ...
                v_s = self.critic(s[index],t[index], p_a[index])
        ...
        for sample in range(self.num_sample):
            ...
            while True:
                ...
                self.replay_buffer.store(
                    s,
                    [
                        info["funding_count_down_hour"],
                        info["funding_count_down_minute"],
                    ],
                    ...
                    s_,
                    [
                        info_["funding_count_down_hour"],
                        info_["funding_count_down_minute"],
                    ],
