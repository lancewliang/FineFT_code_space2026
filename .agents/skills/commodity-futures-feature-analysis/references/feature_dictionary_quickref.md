...
| **Cross-Month Contract** | `cm_contract_role_*`, `cm_main_sub_*`, `cm_m1_m2_log_price_spread_velocity_10m`, `cm_m2_m3_log_price_spread_velocity_10m`, `cm_m1_m2_m3_butterfly_spread_velocity_10m` | `cross_month_feature.py` | Sec 3.8 | Main contract vs term structure spreads, spread velocity & liquidity shift |
