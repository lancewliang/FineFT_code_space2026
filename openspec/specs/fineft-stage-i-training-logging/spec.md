# fineft-stage-i-training-logging Specification

## Purpose
Define logging requirements for FineFT Stage I low-level training diagnostics, especially epoch-boundary visibility into the latest diverse-training performance for each `df_index + rollout_index`.
