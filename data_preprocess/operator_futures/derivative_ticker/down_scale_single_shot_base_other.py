...
def down_scale_single_oe_snapshot(ticker_df: pl.DataFrame, agg_freq: str):
    return (
        ticker_df.sort("timestamp")
...
def main(args):
    ...
    single_df = pl.read_ipc(os.path.join(ticker_dir, args.date + ".feather"))
